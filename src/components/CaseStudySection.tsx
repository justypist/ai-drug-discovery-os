      ...
      <div className="mx-auto w-full max-w-7xl px-4 md:px-6">
            ...
            {timeline.map((m, i) => (
              <div key={i} className="flex flex-1 items-start">
                <div className="flex min-w-0 flex-1 flex-col items-center text-center">
                  ...
                  <div className="w-full break-words text-sm font-medium leading-tight text-ink md:text-base">
                    {m.label}
                  </div>
                </div>
              </div>
        ...
        <div className="mt-4 rounded-2xl border border-hairline bg-card p-4 md:p-5">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {metrics.map((m) => (
              <div key={m.label} className="rounded-xl border border-hairline bg-paper p-4 shadow-sm">
                ...
                <div className="mt-3 flex items-center justify-between gap-4">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs font-bold text-teal md:text-sm">+{(m.after - m.before).toFixed(1)}pp</span>
                  </div>
                  <div className="text-center">
