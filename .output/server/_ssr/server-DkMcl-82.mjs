...
import { t as createMiddleware } from "./createStart-BpWiTpbN.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-3zZD67wo.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DMBl7VUO.mjs"),
		import("./start-DrjL39JC.mjs"),
